...
class TreeTestCase(unittest2.TestCase):
    ...
    def test_canonical_individual(self):
        ...
        self.tree.graphviz("test_Tree_%s.dot" % (Self.name()))
    ...
    #"""
    # These unit tests work with dict in Tree.py
    # These unit tests are excluded when using CPT in Tree.py
